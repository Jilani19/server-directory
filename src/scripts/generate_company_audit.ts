...
const limit = pLimit(15); // Concurrent workers

async function attemptAPI(name: string, url: string): Promise<any> {
...
async function runAudit() {
  ...
  fs.writeFileSync("C:/Users/JILANI/.gemini/antigravity-ide/brain/cdcdf833-10e5-4103-8430-a2650aa7b751/company_audit.json", JSON.stringify(auditReport, null, 2));
