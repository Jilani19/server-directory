...
let schema = fs_1.default.readFileSync(schemaPath, 'utf8');
...
schema = schema.replace(/model Drug \{[\s\S]*?(?=\n\})/, `$&
  // Search & Status Fields
  aliases           String?
  keywords          String?
  searchText        String?
...
schema = schema.replace(/model Product \{[\s\S]*?(?=\n\})/, `$&
  // Search & Status Fields
  aliases           String?
  keywords          String?
  searchText        String?
...
fs_1.default.writeFileSync(schemaPath, finalSchema);
